 ...
 */
     ...
     */
    function webnews_sanitize_number_range( $input, $setting ) {
     ...
     */
    function webnews_sanitize_dropdown_pages( $page_id, $setting ) {
     ...
     */
    function webnews_sanitize_image( $image, $setting ) {
